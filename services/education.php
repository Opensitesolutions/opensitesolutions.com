...
<!-- Center Column -->
		...
		<li><a href="#pos">Open Source Point of Sales</a></li>
		<li><a href="#edu">Open Source Education on CD</a></li>
		</ul>

<h5 id="cms">Content Management Systems</h5>
...
<h5 id="libm">Library Management</h5>
<p class="post align-right">
        <ul>
        <b>Open Source Solutions</b>
...
<h5 id="edu">Educational CD</h5>
<p class="post align-right">
        <ul>
        <b>Open Source Solutions</b>
	<li><a href="http://www.theopendisc.com/education/" target="_blank">OpenEducationDisc</a> purpose is to provide students with the software that they need to complete school work at home. Most students don't have jobs and it is unfair to ask for them or a parent/guardian to buy expensive software to get the best out of their education. Hence everything is free and we encourage you to make copies of this CD and lend it to you friends.  <a href="http://www.theopendisc.com/education/wp-content/uploads/2007/10/openeducationdisc-dvd-v1.png" target="_blank">CD contents</a><li><br>
	<li><a href="http://www.ofset.org/freeduc-cd" target="_blank">Freeduc-cd</a> a LIVE_CD for primary schools, a GNU/Linux distribution which can be used without installation. It is specifically dedicated to the world of education and it enables an easy introduction for stakeholders of education to the 40 free software packages included on the cd-rom.</li><br>
<a href="#top">Top</a>
</ul>
</p>
