...
<div class="col-md-8">
 <div class="container-fluid">
   <!--- begin content --->
    ...
    <h2 id="top">Open source Databases</h2>

    <p class="post align-right">
    <ul>
    <li><a href="http://db.apache.org/derby/" target="_blank">Apache Derby</a> an Apache DB subproject, is an open source relational database implemented entirely in Java </li><br>
    <li><a href="http://www.firebirdsql.org" target="_blank">Firebird</a> is a relational database offering many ANSI SQL standard features that runs on Linux, Windows, and a variety of Unix platforms. Firebird offers excellent concurrency, high performance, and powerful language support for stored procedures and triggers. It has been used in production systems, under a variety of names, since 1981.</li><br>
    ...
    <li><a href="http://www.postgresql.org/" target="blank">Postgresql</a> The worlds most advanced open source database is a powerful, open source relational database syste
    ...
    <li><a href="http://www.sqlite.org" target="_blank">Sqlite</a> is a open source software library that implements a self-contained, serverless, zero-configuration, transac
    tional SQL database engine. SQLite is the most widely deployed SQL database engine in the world. It is used in countless desktop computer applications as well as
