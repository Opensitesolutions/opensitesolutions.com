...
<p class="post align-right">
	...
	<li><a href="http://www.fidelityinfoservices.com/FNFIS/Markets/NonFinancialIndustries/Healthcare/GTM/TechDetail/" target="_blank">G.T.M</a> database architecture includes a robust, high performance, multi-paradigm, open-architecture database. Relational, object-oriented and hierarchical conceptual models can be simultaneously applied to the same data which is accessible to concurrent host-based and client-server applications via C/C++, SQL and M.</li><br>
...
ss. It runs on all major operating systems, including Linux, UNIX (AIX, BSD, HP-UX, SGI IRIX, Mac OS X, Solaris, Tru64), and Windows.</li><br>
        <li><a href="http://www.sqlite.org">Sqlite</a> is a open source software library that implements a self-contained, serverless, zero-configuration, transac
