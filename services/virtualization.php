...
=======
        <li><a href="http://bochs.sourceforge.net/" target="_blank" name="em1">Bochs</a> is a highly portable open source IA-32 (x86) PC emulator written in C++, that runs on most popular platforms. <a href="http://kowabunga-cnet.com.com/2001-3121_9-0.html?tag=sh.glnav&kbid=1805&m=27&i=4"><img border="0" src="http://kowabunga.com.com/b.aspx?id=1805&mm=27&img=notebooks_125x125.gif"/ align="left"></a>It includes emulation of the Intel x86 CPU, common I/O devices, and a custom BIOS. Currently, Bochs can be compiled to emulate a 386, 486, Pentium/PentiumII/PentiumIII/Pentium4 or x86-64 CPU including optional MMX, SSEx and 3DNow! instructions. Bochs is capable of running most Operating Systems inside the emulation including Linux, DOS, Windowsï¿½ 95/98 and Windowsï¿½ NT/2000/XP or Windows Vista. </li><br><Br>
>>>>>>> aa7b7b391414fbd153eab974d0f4402b33ff35d1
        <li><a href="http://fabrice.bellard.free.fr/qemu/" target="_blank" name="em2"> QEMU</a> is a generic and open source machine emulator and virtualizer. When used as a machine emulator, QEMU can run OSes and programs made for one machine (e.g. an ARM board) on a different machine (e.g. your own PC). By using dynamic translation, it achieves very good performances. When used as a virtualizer, QEMU achieves near native performances by executing the guest code directly on the host CPU. A host driver called the QEMU accelerator (also known as KQEMU) is needed in this case. The virtualizer mode requires that both the host and guest machine use x86 compatible processors. </li><br>
<a href="#top">Top</a>
        </ul>
</p>	
...
<p class="post align-right">
        <ul>
        <b>Open Source Solution</b>
	<li><a href="http://freenx.berlios.de/" target="_blank">FreeNX</a> is a free server implementation of NoMachine.com OSS NX components. NX allows usage of X-connections over real slow links like a Modem or ISDN.</li><br>
