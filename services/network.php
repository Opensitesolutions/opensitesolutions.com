...
<head>
    ...
    <title>Open source Network Tools</title>
...
<div class="col-md-8">
 <div class="container-fluid">
   <!--- begin content --->
    ...
    <h1 id="top">Open Source Network Tools</h1>
    ...
    <ul>
    <b>Open Source Solution</b>
    <li><a href="http://www.areca-backup.org/" target="_blank">Areca</a> is an open source alternative backup solution. It allows you to select a set of files / directories to choose to backkup.</li><br>
    <li><a href="http://backupmill.com/" target="_blank">Backupmill</a> is an open source alternative backup solution. Is designed to backup your files as fast as possible with minimal effort. Encrypts backups using AES-256, stores backup on HDD, flash devices, remote FTP server or network computers. </li><br>
    <li><a href="http://www.bacula.org/en/" target="_blank">Bacula</a> is an open source alternative backup solution. It is a set of programs that perform backup, recovery and verification of computer data across a network. </li><br>
    <li><a href="http://www.nasbackup.com" target="_blank">NasBackup</a> is an open source alternative backup solution. It is a high-performance, enterprise-grade system for backing up MS Windows desktop PCs, laptops and servers to network disks. NasBackup is a highly configurable solution and easy to install and maintain.</li><br>
