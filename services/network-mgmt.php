...
All this information can be limited by network or sensor in order to provide just the needed information to specific users allowing for a fine grained multi-user security environment. Also, the ability to act as an IPS (Intrusion Prevention System) based on correlated information from virtually any source result in a useful addition to any security professional
	<ul>
   	<li>Arpwatch, used for mac anomaly detection.</li>
		...
		<li><a href="http://www.racktables.org/" target="_blank">Racktables</a> robost asset management solution for tracking items within a datacenter, server room. If helps document hardware, assets, network addresses, space in rack, network configuration and more</li><br>
		<li><a href="http://spacewalk.redhat.com/" target="_blank">Spacewalk</a> open source linux management solution for tracking software and other management capabilities.</li><br>
