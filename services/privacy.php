...
oia yet, see the installation instructions below for how to disable this feature.</li><br>
	<li><a href="http://www.freeotfe.org/" target="_blank">FreeOTFE</a> is a free, open source, "on-the-fly" transparent disk encryption program for PCs and PDAs</li><br><br>
	<li><a href="http://www.scherrer.cc/crypt/" target="_blank"> CrossCrypt</a> Open Source AES and TwoFish Linux compatible on the fly encryption for Windows XP and Windows 2000. Crosscrypt is an on the fly and offline encryption.<li><br>
...
ivirus comes with an easy installer and open source code. You may download and use it absolutely free of charge. It features:
   <ul>
    ...
    <li> Addin to Microsoft Outlook to remove virus-infected attachments automatically.</li>
        ...
        <li><a href="http://www.spybot.net/en/home/index.html">SpyBot</a> Search & Destroy detects and removes spyware, a relatively new kind of threat not yet co
vered by common anti-virus applications. Spyware silently tracks your surfing behaviour to create a marketing profile for you that is transmitted without your kno
wledge to the compilers and sold to advertising companies. If you see new toolbars in your Internet Explorer that you haven't intentionally installed, if your bro
wser crashes inexplicably, or if your home page has been "hijacked" (or changed without your knowledge), your computer is most probably infected with spyware. Eve
n if you don't see the symptoms, your computer may be infected, because more and more spyware is emerging.</li><br>
        <li><a href="http://www.heidi.ie/eraser/">Eraser</a> is an advanced open source security tool (for Windows), which allows you to complete
